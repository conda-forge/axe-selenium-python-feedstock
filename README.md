...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/axe-selenium-python-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13438&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/axe-selenium-python-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `axe-selenium-python` can be installed with:

```
conda install axe-selenium-python
```

It is possible to list all of the versions of `axe-selenium-python` available on your platform with:
